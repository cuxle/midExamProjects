...
FormLogin::~FormLogin()
{
    ...
    QProcess process(0);
    process.start("cmd.exe", QStringList()<< "/c" << "taskkill /im server.exe /f");
...
//void FormLogin::on_cmbUserId_currentIndexChanged(int index)
//{
//    QString currentId = ui->cmbUserId->itemText(index);
//    updateUserNameListInfo(currentId);
//}


//void FormLogin::on_cmbUserId_currentTextChanged(const QString &arg1)
//{
//   // updateUserNameListInfo(arg1);
//}
...
//void FormLogin::on_cmbUserId_editTextChanged(const QString &arg1)
//{
//    //updateUserNameListInfo(arg1);
//}
