...
//     QString m_saveVideoFormat = ".mp4v";
     ...
     QString m_mediapath60s = "qrc:/resource/sound/skipRope60s.mp3";
     QString m_mediapath30s = "qrc:/resource/sound/skipRope30s.mp3";
     QString m_currentMediaFile;

     bool m_enableStartSound = false;
     bool m_startBackTimerAfterFirstJump = true;
